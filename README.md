...
const Example = (props) => {
  ...
  const _onLocalNetworkQuality = ({participant, quality}) => {
    console.log("onLocalNetworkQuality: ", participant, quality)
  }
  const _onRemoteNetworkQuality = ({participant, quality}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TwilioVideo
        ...
        onLocalNetworkQuality = { onLocalNetworkQuality }
        onRemoteNetworkQuality = { onRemoteNetworkQuality }
      />
    </View>
  );
}
